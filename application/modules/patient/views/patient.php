    ...
    <section class="wrapper site-min-height">
        ...
        <section class="">
            ...
            <header class="panel-heading">
                <?php echo ('Danh sách'); ?> <?php echo ('bệnh nhân'); ?>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <?php } ?> -->
                                <th class="no-print"><?php echo ('Chức Năng'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <style>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  <?php echo ('Đăng ký bệnh nhân'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">

                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo ('Họ tên và lớp'); ?></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo ('CCCD / CMDD '); ?></label>
                        <input type="text" class="form-control" name="phone" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo ('Giới tính'); ?></label>
                    ...
                    <div class="form-group col-md-6">
                        <label><?php echo ('Ngày Sinh'); ?></label>
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo ('Ghi chú'); ?></label>
                    ...
                    <!-- <div class="form-group col-md-6">    
                        <label for="exampleInputEmail1"><?php echo ('Bác sĩ'); ?></label>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  <?php echo ('Chỉnh sửa bệnh nhân'); ?></h4>
            </div>
            <div class="modal-body row">
...
<div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg"> 
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  <?php echo ('Thông'); ?>  <?php echo ('Tin'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1"><?php echo ('Tên sinh viên'); ?></label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1"><?php echo ('Địa chỉ'); ?></label>
                        <div class="addressClass"></div>
                    </div>

                    <div class="form-group col-md-4">
                        <label for="exampleInputEmail1"><?php echo ('Phái'); ?></label>
